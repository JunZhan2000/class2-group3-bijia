...
async def spider_parser(res):
    ...
    for link in links:
        ...
        try:
            name = link.xpath('p[@class="productTitle"]/a[1]/text()[1]')[0]+link.xpath('p[@class="productTitle"]/a[1]/span/text()[1]')[0]+link.xpath('p[@class="productTitle"]/a[2]/text()[2]')[0]
        except:
            try:
